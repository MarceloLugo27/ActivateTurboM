...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="section no-pad-bot" id="index-banner">
            <div class="container">
                <br>
                <div class="row center"><asp:Image ID="Image1" class="responsive-img" runat="server" ImageUrl="~/image/logoAT.png" /></div>
                <br>
                ...
                <div class="row center">
                    <asp:HyperLink ID="hlRegistro" href="Registro.aspx" class="waves-light indigo lighten-2 btn-large" runat="server">Registrarme</asp:HyperLink>
                </div>
                <br>
                <br>
            </div>
